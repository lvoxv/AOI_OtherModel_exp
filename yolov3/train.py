...
# 训练命令
# python train.py --data dataset.yaml --weights yolov3.pt --img 640
# python train.py --data data/coco128.yaml --weights '' --cfg models/yolov5s.yaml --img 640
# python train.py --data data/coco128.yaml --weights yolov5s.pt --img 640 --device 0,1,2,3
# python -m torch.distributed.run --nproc_per_node 4 --master_port 1 train.py --data data/coco128.yaml --weights yolov5s.pt --img 640 --device 0,1,2,3
